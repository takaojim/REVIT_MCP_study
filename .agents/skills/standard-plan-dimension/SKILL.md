...
| 方向 | 軸線端點（圖紙 40mm） | 圓圈 (Bubble) | 第 1 層（距端點 5mm / 外牆 35mm） | 第 2 層（距端點 10mm / 外牆 30mm） | 第 3 層（距端點 15mm / 外牆 25mm） |
| :--- | :--- | :---: | :--- | :--- | :--- |
| **上方 (North)** | $Y_{\max} + 40 \times S$ | ⭕ 有 | **柱心全區總尺寸** | **各柱間距連續分段尺寸** | 外牆房間隔間與門窗開口 |
| **右側 (East)** | $X_{\max} + 40 \times S$ | ⭕ 有 | **柱心全區總尺寸** | **各柱間距連續分段尺寸** | 外牆房間隔間與門窗開口 |
| **下方 (South)** | $Y_{\min} - 40 \times S$ | ❌ 無 | **外牆房間隔間與門窗開口** | *(細部開口或備用層)* | — |
| **左側 (West)** | $X_{\min} - 40 \times S$ | ❌ 無 | **外牆房間隔間與門窗開口** | *(細部開口或備用層)* | — |
...
### 步驟 4：套用專屬標註型式 (Dimension Type)
* 北側與東側標註套用：`TABC-DIM_*/ S 2.5-柱心-上右`
* 南側與西側標註套用：`TABC-DIM_*/ S 2.5-柱心-下右`
