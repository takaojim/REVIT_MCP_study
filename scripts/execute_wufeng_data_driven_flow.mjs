...
// Template coordinates for Page 1 in view 721395 (X: 3000.00 ~ 3791.90 mm)
...
// 00:08 穩健基準字寬權重：48.5 (100% 絕對杜絕 Revit 意外二次折行)
...
// 18 Articles of Wufeng Structured as Atomic Units
export const WUFENG_RAW_ARTICLES = [
  {
    num: '一、',
    clauses: [
      { text: `本要點依據都市計畫法第22條、第32條及都市計畫法臺中市施行自治條例第49條規定訂定之。` }
    ]
  },
  {
    num: '二、',
  ...
  },
  {
    num: '三、',
    clauses: [
      { text: `乙種工業區申請設置公共服務設施及公用事業設施，其使用細目、使用面積、使用條件及管理維護事項之核准條件如附表；申請作業程序及應備書件，依「臺中市都市計畫甲種乙種工業區土地申請設置公共服務設施及公用事業設施總量管制作業要點」規定辦理。` }
    ]
  },
  {
    num: '四、',
    clauses: [
      { text: `電信專用區之土地使用項目悉依「都市計畫法臺中市施行自治條例」第41條第1項第1至4款規定辦理。` }
    ]
  },
  {
    num: '五、',
  ...
  },
  {
    num: '六、',
    clauses: [
      { text: `機關用地（霧-機3）內議員會館及機關用地（霧-機5）內國立臺灣交響樂團坐落範圍，依促進民間參與公共建設法相關規定辦理委外經營管理時，其使用項目得為旅館業及其附屬設施使用。` }
    ]
  },
  {
    num: '七、',
    intro: `社會福利設施用地得為下列之使用：`,
    clauses: [
      { text: `（一）作社會住宅使用。` },
      { text: `（二）依住宅法第33條規定，應保留一定空間供作社會福利服務、長期照顧服務、身心障礙服務、托育服務、幼兒園、青年創業空間、社區活動、文康休閒活動、商業活動、餐飲服務或其他必要附屬設施之用。` },
      { text: `（三）其他經臺中市都市計畫委員會同意容許使用項目。` }
    ]
  },
  {
    num: '八、',
    clauses: [
      { text: `「霧-社2」社教用地專供設置九二一地震教育園區及其他相關附屬設施使用，提供展示空間及教育活動等，並得設置行政辦公廳舍及餐飲服務設施，且新建建築物應自基地北側計畫道路境界線至少退縮5公尺建築，退縮部分得計入法定空地，並應妥為植栽綠化。` }
    ]
  },
  {
    num: '九、',
    intro: `為鼓勵設置公益性設施，除經劃設為都市更新單元之地區，另依都市更新條例規定辦理外，訂定下列獎勵措施；其建築物提供部分樓地板面積供下列使用，得增加所提供之樓地板面積，但以不超過基地面積乘以該基地容積率之10％為限：`,
    clauses: [
      { text: `（一）私人捐獻或設置圖書館、博物館、藝術中心、兒童、青少年、勞工、老人等活動中心、景觀公共設施等供公眾使用；其集中留設之樓地板面積在100平方公尺以上，並經目的事業主管機關核准設立公益性基金管理營運者外，申請建造執照時，前開公益性基金會應為公益性設施之起造人。` },
      { text: `（二）建築物留設空間與天橋或地下道連接供公眾使用，經道路主管機關核准者。` }
    ]
  },
  {
    num: '十、',
    clauses: [
      { text: `本計畫「霧-公1」公園用地得依都市計畫公共設施用地多目標使用辦法規定優先興建地下停車場供公共停車使用。` }
    ]
  },
  {
    num: '十一、',
    clauses: [
      { text: `霧峰聯合辦公廳舍範圍應自道路境界線至少退縮2公尺建築，其退縮地不計入法定空地面積。` }
    ]
  },
  {
    num: '十二、',
    clauses: [
      { text: `建築基地內之法定空地扣除依相關法令規定無法綠化之面積後應留設二分之一以上種植花草樹木予以綠化；但因設置無遮簷人行道、裝卸位、車道及現有道路，致法定空地未達應種植花草樹木面積者，則僅限實設空地須種植花草樹木，並依建築技術規則建築設計施工編綠建築基準之建築基地綠化規定以綠化總二氧化碳固定量及二氧化碳固定量基準值做檢討。法定空地面積每滿64平方公尺應至少植喬木1棵，其綠化工程應納入建築設計圖說於請領建造執照時一併核定之，覆土深度草皮應至少30公分、灌木應至少60公分、喬木應至少120公分。` }
    ]
  },
  {
    num: '十三、',
    intro: `本計畫區內應提送都市設計審議範圍：`,
    clauses: [
      { text: `（一）公有建築之審議依臺中市公有建築應送都市設計委員會審議要點規定辦理。` },
      { text: `（二）公用事業（包括電信局、航空站、大客車運輸業之轉運站、公私立大型醫院、文大及文教區等）建築申請案之總樓地板超過10,000平方公尺者。` },
      { text: `（三）新建建築達以下規模：
    1. 新建建築樓層高度12層以上。
    2. 住宅區新建之建築基地面積超過6,000平方公尺者。
    3. 商業區新建之建築基地面積超過3,000平方公尺者。
    4. 住宅區及商業區新建總樓地板面積超過30,000平方公尺者。` },
      { text: `（四）新闢立體停車場基地面積6,000平方公尺以上者。但建築物附屬停車場者，不在此限。` },
      { text: `（五）實施容積管制前已申請或領有建造執照，在建造執照有效期間內，依建築技術規則建築設計施工編第166條之1第2項執照之申請案。` },
      { text: `前項各款建築基地之建築基地規模、開放空間、人車通行系統、交通運輸系統、建築量體造型與色彩、景觀計畫、環境保護設施、防災空間、氣候調適與管理維護計畫等都市設計相關事項，應提送臺中市政府都市設計審議委員會審議，經審議通過後，始依法核發建照。` }
    ]
  },
  {
    num: '十四、',
    intro: `為鼓勵都市老舊地區申辦獎勵老舊建物重建，屬商業區及住宅區之建築基地，其達都市設計審議規模者從其規定，符合下列條件得予以獎勵基準容積之20％或15％：`,
    clauses: [
      { text: `（一）基地面積500平方公尺以上，30年以上鋼筋混凝土造、預鑄混凝土造及鋼骨混凝土造合法建築物坐落之建築基地與其他土地上之違章建築物投影面積合計達申請重建基地面積之二分之一，其中30年以上合法建築物坐落之建築基地應達前述面積總和二分之一，得申請獎勵基準容積之20％。` },
      { text: `（二）基地面積500平方公尺以上，土磚造、木造、磚造及石造合法建築物、20年以上之加強磚造及鋼鐵造合法建築物坐落之建築基地與其他土地上之違章建築物投影面積合計達申請重建基地面積之二分之一，其中合法建築物坐落之建築基地應達前述面積總和二分之一，得申請獎勵基準容積之15％。` },
      { text: `（三）經全部土地所有權人同意。` },
      { text: `（四）建築配置時，應自基地退縮二側，包括基地後側及側面，側面得選擇一側並連通至道路，該退縮淨寬至少1.5公尺。` },
      { text: `（五）不得再申請建築技術規則所訂定開放空間獎勵。` }
    ]
  },
  {
    num: '十五、',
    intro: `停車空間留設規定如下：`,
    clauses: [
      { text: `（一）本計畫區建築物附設停車空間設置標準依建築技術規則設計施工編第59條所列第一類建築物用途，樓地板面積300平方公尺以下免設汽車停車位，但至少須設置1輛機車（或自行車）停車位，超過300平方公尺部分每150平方公尺設置1輛汽車與1輛機車（或自行車）停車位；第二類建築物用途，樓地板面積500平方公尺以下免設汽車停車位，超過500平方公尺部分每150平方公尺設置1輛汽車停車位與1輛機車（或自行車）停車位。` },
      { text: `（二）機車（或自行車）停車位標準為每輛之長度不得小於1.8公尺、寬度不得小於0.9公尺，其集中設置部數在20部（含）以上者，得以每部4平方公尺核計免計入總樓地板面積，機車（或自行車）停車位應設置於地面層或地下一層，必要時得延伸至地下二層。` }
    ]
  },
  {
    num: '十六、',
    intro: `受保護樹木之保護：`,
    clauses: [
      { text: `（一）為保存與維護計畫區內經本府認定並公告列管之「受保護樹木」及其必要生育地環境，應依「臺中市樹木保護自治條例」之規定辦理。` },
      { text: `（二）建築基地及公共設施用地申請建築開發時，應配合受保護樹木位置集中留設開放空間，以其必要生育地環境及面積至少50平方公尺之範圍為原則，得計本要點第九條之應綠化面積。惟經「臺中市樹木保護委員會」審議同意無需原地保留之受保護樹木者不在此限。` },
      { text: `（三）建築基地及公共設施用地申請建築開發時，應檢附基地現況植栽調查與測量資料，至少包括樹種、位置、樹徑樹冠等相關資料。` }
    ]
  },
  {
    num: '十七、',
    clauses: [
      { text: `建築基地屬已發布細部計畫範圍內之土地，其土地及建築物之使用，悉依該細部計畫之規定辦理；其餘未規定事項或細部計畫未訂定土地使用分區管制要點之地區，應依本要點管制之。` }
    ]
  },
  {
    num: '十八、',
    clauses: [
      { text: `本要點未規定事項適用都市計畫法臺中市施行自治條例及其他有關法令之規定辦理。` }
    ]
  }
];

// 計算獨立分項高度與文字包裝 (00:08 獨立步進模型)
...
function calculateTableHeight(tbl) {
  const headerHeight = 9.0;
  let rowsHeight = 0;
  for (const row of tbl.rows) {
    rowsHeight += 8.0;
  }
  const totalTableH = headerHeight + rowsHeight + 3.0;
  return totalTableH;
}

// 00:08 雙欄流式空間分配運算 (以分項為原子單位)
function computeTwoColumnFlow() {
  ...
  for (let aIdx = 0; aIdx < WUFENG_RAW_ARTICLES.length; aIdx++) {
    const art = WUFENG_RAW_ARTICLES[aIdx];
    ...
    if (art.isTable) {
      ...
      const tblH = calculateTableHeight(art.table);
...
function renderColumnFromItems(tCoords, items) {
  ...
  for (const item of items) {
    ...
    notes.push({ x: tCoords.col1 + 3.0, y: rowStartY - 2.5, text: item.num, typeId: FONT_3MM_TYPE_ID });
    ...
    if (item.isTable) {
      ...
      // 00:08 穩健獨立分項渲染：每項自帶天然防禦間距，永不疊加誤差
...
async function main() {
  ...
  client.clientName = 'wufeng-restore-0008-' + Date.now();
  await client.connect();

  const viewId = 721395; // "2_都市計畫1 測試霧峰"
  console.log(`\n=== 執行【2_都市計畫1 測試霧峰】(ID: ${viewId}) 復原至 00:08 穩健黃金版 ===\n`);
  ...
  console.log('\n========================================================');
  console.log('✅ 【2_都市計畫1 測試霧峰】已成功復原至 00:08 穩健黃金版！');
  console.log('- 1. 折行權重 48.5：100% 免疫 Revit 二次強制折行');
  console.log('- 2. 分項獨立步進：段落層次分明，零誤差滾雪球');
  console.log('- 3. 滿版接續跨欄：徹底消除左下空大欄，零切線、零疊字');
  console.log('========================================================\n');
  process.exit(0);
}
