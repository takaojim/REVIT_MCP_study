...
async function main() {
  ...
  client.clientName = 'position-a401-viewports';
  await client.connect();

  console.log('=== Positioning Sheet A401 Viewports in 2x2 Clean Grid ===');

  const positions = [
    { viewportId: 650365, position: { x: 220, y: 440 } }, // 剖面 1 (Top Left)
    { viewportId: 650366, position: { x: 620, y: 440 } }, // 剖面 2 (Top Right)
    { viewportId: 650367, position: { x: 220, y: 175 } }, // 剖面 3 (Bottom Left)
    { viewportId: 694074, position: { x: 620, y: 175 } }  // 剖面 4 (Bottom Right)
  ];
